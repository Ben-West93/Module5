...
try:
    ...
    with unmetered():
        ...
        # hand would.
        r = request(client, "POST", "/items", json={"name": "Newest"}, expect=201, label="create the newest item")
        ...
        if newest is not None:
            ...
            r = request(client, "POST", "/items", json={"name": "After"}, expect=201, label="create another after deleting it")
