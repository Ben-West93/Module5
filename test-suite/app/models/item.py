# exercises/test-suite/app/models/item.py
# L10 — Item ORM model
...
class Item(Base):
    ...
    __tablename__ = "items"
    # Never reuse an id, as for tasks (see models/task.py). The API has no
    # item delete, but a row removed by hand would otherwise free its id.
