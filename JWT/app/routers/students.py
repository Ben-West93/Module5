# exercises/jwt/app/routers/students.py
...
def create_student(
    ...
    """Creates a new student. Requires a bearer token. Duplicate email is 409.

    `current_user` is unused in the body on purpose: declaring the dependency
    is what enforces the login, because FastAPI resolves it before this
    function runs and a missing or bad token raises 401 first.
    """
